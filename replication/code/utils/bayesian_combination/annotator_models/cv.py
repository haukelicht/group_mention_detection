...
from utils.bayesian_combination.annotator_models.annotator_model import Annotator, log_dirichlet_pdf
...
class ConfusionVectorAnnotator(Annotator):
	...
	def __init__(self, alpha0_diags, alpha0_factor, L, nModels):
		...
		self.alpha0 = alpha0_base * np.ones((L, L)) + alpha0_correct * np.eye(L)
